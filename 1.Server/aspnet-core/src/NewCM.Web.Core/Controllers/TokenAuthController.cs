...
namespace NewCM.Controllers
{
    ...
    public class TokenAuthController : NewCMControllerBase
    {
        ...
        public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            // Kiểm tra tài khoản nhân viên hay khách hàng
            if (loginResult.User.IsCustomer != model.IsCustomer)
            ...
            return new AuthenticateResultModel
            {
                ...
                ProfilePicture = loginResult.User.ProfilePicture != null ? Convert.ToBase64String(loginResult.User.ProfilePicture) : AppConsts.ProfilePicture
            };
        }
