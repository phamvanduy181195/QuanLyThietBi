...
namespace NewCM.Localization
{
    public class LocalizedIdentityErrorDescriber : IdentityErrorDescriber
    {
        public override IdentityError DuplicateEmail(string email)
        {
            ...
            {
                Code = "DuplicateUserName1",//nameof(DuplicateEmail),
                Description = string.Format("Email {0} đã tồn tại!", email)
            };
        }

        //public new IdentityError DuplicateEmail(string email)
        //{
        //    var result = base.DuplicateEmail(email);
        //    result.Description = "ABC he he he";
        ...
        //{
        //    var result = base.DuplicateUserName(userName);
        //    result.Description = "ABC he he he";
        ...
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError
            {
                Code = "DuplicateUserName1",//nameof(DuplicateUserName),
                Description = string.Format("ABC ha ha ha")
            };
        }
