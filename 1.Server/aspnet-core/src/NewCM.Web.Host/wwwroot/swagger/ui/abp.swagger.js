...
(function () {
    ...
    function loginUserInternal(tenantId, callback) {
        ...
        // HuyPhong - Lấy giá trị của checkbox IsCustomer
        ...
        xhr.send("{" + "usernameOrEmailAddress:'" + usernameOrEmailAddress + "'," + "password:'" + password + "', isCustomer:'" + isCustomer + "'}");
    };
    ...
    abp.swagger.openAuthDialog = function (loginCallback) {
        ...
        input.id = 'isCustomer';
        input.name = 'isCustomer';
        input.type = 'checkbox';
        input.style.marginRight = '5px';
        wrapper.appendChild(input);
        wrapper.append('Is customer');
